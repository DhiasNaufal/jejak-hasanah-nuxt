import { M as MaybeTransition, m as makeTransitionProps, _ as __nuxt_component_2$1, V as VContainer } from "./transition-Cm8Ae_8P.js";
import { ag as isOn, ah as eventName, g as genericComponent, c as propsFactory, J as _export_sfc, f as VIcon, ai as wrapInArray, Y as useProxiedModel, S as getCurrentInstance, aj as getUid, ak as defineComponent, I as IconValue, m as makeComponentProps, d as makeTagProps, u as useRender, h as VDefaultsProvider, al as EventProp, i as makeBorderProps, e as makeDensityProps, j as makeDimensionProps, k as makeElevationProps, q as makeRoundedProps, r as makeRouterProps, s as makeThemeProps, t as makeVariantProps, R as Ripple, F as useLink, v as provideTheme, w as useBorder, x as useVariant, y as useDensity, z as useDimension, A as useElevation, E as useRounded, am as deprecate, G as genOverlays, a6 as useTextColor, T as convertToUnit, an as deepEqual, Q as useBackgroundColor, p as provideDefaults, ao as focusChild, ap as getPropertyFromItem, a4 as omit, aq as destructComputed, ar as parseAnchor, as as flipSide, at as flipAlign, au as flipCorner, av as consoleError, aw as getAxis, ax as clamp, ay as defer, az as templateRef, aA as IN_BROWSER, aB as matchesSelector, aC as useToggleScope, K as useRtl, aD as useRouter, aE as isClickInsideElement, ac as focusableChildren, aF as getNextElement, H as VBtn, X as __nuxt_component_0$1, b as __nuxt_component_0$2, V as VRow, a as VCol } from "../server.mjs";
import { createVNode, Transition, mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext, inject, shallowRef, provide, toRaw, ref, computed, toRef, withDirectives, vShow, watch, Fragment, resolveDirective, onScopeDispose, nextTick, watchEffect, effectScope, reactive, readonly, warn, Teleport, openBlock, createBlock, renderList, defineComponent as defineComponent$1, unref } from "vue";
...
import { a as animate, d as deceleratedEasing, s as standardEasing, b as acceleratedEasing, g as getTargetBox, n as nullifyTransforms, c as VExpandTransition, B as Box, e as getOverflow, u as useScopeId, f as forwardRefs } from "./scopeId-ChrUZLWz.js";
import { u as useSsrBoot, m as makeLazyProps, a as useLazy } from "./ssrBoot-DuXNnEEs.js";
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(VIcon, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`${ssrInterpolate($props.icon)}`);
      } else {
        return [
  ...
  _push(`<div><p class="text-JH-grey text-sm my-0">${ssrInterpolate($props.title)}</p><p class="">${ssrInterpolate($props.information)}</p></div></div>`);
}
const _sfc_setup$4 = _sfc_main$4.setup;
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Navbar/Information.vue");
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_NavbarInformation = __nuxt_component_2;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white md:flex gap-3 hidden" }, _attrs))}><div class="sm:w-[40%] hidden sm:flex justify-end py-5">`);
  ...
  _push(`</div><div class="flex flex-col justify-end w-[60%]"><div id="contact" class="flex gap-10 items-center pl-12 pb-4">`);
  _push(ssrRenderComponent(_component_NavbarInformation, {
    icon: "mdi-email",
    title: "Email",
  ...
  _push(`</div><div id="navbar" class="triangle text-white px-16 w-full h-[40%] bg-black flex items-center gap-20 text-sm"><!--[-->`);
  ssrRenderList($data.navMenu, (menu, index) => {
    _push(`<div>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VBtn, {
              variant: "text",
              class: "text-subtitle-1 font-sans"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(menu.title)}`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VMenu, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VList, { class: "bg-text" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<!--[-->`);
                        ssrRenderList(menu.path, (item, index2) => {
                          _push4(ssrRenderComponent(_component_NuxtLink, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(VListItem, { value: index2 }, {
                                ...
                                return [
                                  createVNode(VListItem, { value: index2 }, {
                                    default: withCtx(() => [
                                      createVNode(VListItemTitle, null, {
                                        default: withCtx(() => [
                                          createTextVNode(toDisplayString(item.title), 1)
                        ...
                        return [
                          (openBlock(true), createBlock(Fragment, null, renderList(menu.path, (item, index2) => {
                  ...
                  return [
                    createVNode(VList, { class: "bg-text" }, {
                      default: withCtx(() => [
                        (openBlock(true), createBlock(Fragment, null, renderList(menu.path, (item, index2) => {
                          return openBlock(), createBlock(_component_NuxtLink, {
                            key: index2,
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/app/navbar/index.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(VContainer, mergeProps({ class: "pa-0" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<section class="h-full bg-cover bg-center rounded-tl-3xl rounded-tr-3xl" style="${ssrRenderStyle({ "background-image": "url('/img/home/footerBanner.jpeg')" })}"${_scopeId}><div class="opacity flex flex-col items-center justify-center py-16 gap-5 rounded-tl-3xl rounded-tr-3xl"${_scopeId}><h1 class="text-4xl font-semibold text-white"${_scopeId}> Hubungi kami untuk obrolan lebih lanjut </h1><div class="flex gap-3"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_AppButtonPrimary, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`Hubungi`);
            } else {
              return [
                createTextVNode("Hubungi")
              ];
            }
          }),
          _: 1
        ...
        return [
          createVNode("section", {
            ...
            createVNode("div", { class: "opacity flex flex-col items-center justify-center py-16 gap-5 rounded-tl-3xl rounded-tr-3xl" }, [
              createVNode("h1", { class: "text-4xl font-semibold text-white" }, " Hubungi kami untuk obrolan lebih lanjut "),
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/app/footer/Banner.vue");
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent$1({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_2$1;
      _push(`<!--[--><div class="bg-text py-10 relative overflow-hidden">`);
      _push(ssrRenderComponent(VContainer, { class: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VCol, { cols: "2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_AppTextH5, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Another Page`);
                            } else {
                        ...
                        _push4(`<!--[-->`);
                        ssrRenderList(unref(menuMock).menu, (item) => {
                          _push4(`<div class="flex items-center"${_scopeId3}>`);
                          _push4(ssrRenderComponent(VIcon, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`mdi-menu-right`);
                              } else {
                                return [
                                  createTextVNode("mdi-menu-right")
                                ];
                              }
                            }),
                            _: 2
                        ...
                        return [
                          createVNode(_component_AppTextH5, null, {
                            default: withCtx(() => [
                              createTextVNode("Another Page")
                            ]),
                            _: 1
                          }),
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(menuMock).menu, (item) => {
                  ...
                  _push3(ssrRenderComponent(VCol, { cols: "3" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<!--[-->`);
                        ssrRenderList(contact, (item) => {
                          _push4(`<div class="flex items-start"${_scopeId3}>`);
                          _push4(ssrRenderComponent(VIcon, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                          ...
                          _push4(ssrRenderComponent(_component_NuxtLink, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                        ...
                        return [
                          ...
                          (openBlock(), createBlock(Fragment, null, renderList(contact, (item) => {
                            return createVNode("div", { class: "flex items-start" }, [
                              createVNode(VIcon, null, {
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(item.icon), 1)
                                ]),
                  ...
                  _push3(ssrRenderComponent(VCol, { cols: "2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<p${_scopeId3}>Follow Us For Update</p><div${_scopeId3}><!--[-->`);
                        ssrRenderList(socialMedia, (item) => {
                          _push4(ssrRenderComponent(VIcon, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`${ssrInterpolate(item.icon)}`);
                        ...
                        return [
                          ...
                          createVNode("p", null, "Follow Us For Update"),
                          createVNode("div", null, [
                            (openBlock(), createBlock(Fragment, null, renderList(socialMedia, (item) => {
      ...
      _push(`</div><div class="text-center bg-white"> Copyright © 2024 Jejak Hasanah. All right reserved. </div><!--]-->`);
    };
  }
});
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/app/footer/index.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_AppNavbar = __nuxt_component_0;
  const _component_AppFooterBanner = __nuxt_component_1;
  const _component_AppFooter = _sfc_main$1;
  _push(`<!--[-->`);
  _push(ssrRenderComponent(_component_AppNavbar, null, null, _parent));
  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(ssrRenderComponent(_component_AppFooterBanner, null, null, _parent));
...
//# sourceMappingURL=default-CJxL9L7v.js.map
