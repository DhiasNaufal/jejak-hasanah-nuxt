import { effectScope, reactive, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, version as version$1, unref, ref, watchEffect, watch, h, shallowRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, onScopeDispose, Fragment, computed, toRefs, capitalize, warn, provide, defineComponent as defineComponent$1, createVNode, mergeProps, readonly, Suspense, nextTick, Transition, withCtx, useSSRContext, onUpdated, Text, resolveDynamicComponent, withDirectives, renderSlot, createTextVNode, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
import "klona";
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, withLeadingSlash, encodeParam, encodePath } from "ufo";
import "devalue";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderSlot, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const _routes = [
  ...
  },
  {
    ...
    path: "/advertising/portofolio",
    meta: {},
    alias: [],
    redirect: __nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.redirect,
    component: () => import("./_nuxt/portofolio-DTDf2rqc.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-BgOHrp6E.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/_detail_-Bn8nexos.js").then((m) => m.default || m)
  },
  {
    name: "portofolio",
    path: "/portofolio",
    ...
    component: () => import("./_nuxt/index-BYStc8Kn.js").then((m) => m.default || m)
  },
  {
    name: "tentang",
    path: "/tentang",
    ...
    component: () => import("./_nuxt/index-DQSSNqjW.js").then((m) => m.default || m)
  },
  {
    name: "transportation",
    path: "/transportation",
...
const layouts = {
  404: () => import("./_nuxt/404-T3VsUjF8.js").then((m) => m.default || m),
  default: () => import("./_nuxt/default-CJxL9L7v.js").then((m) => m.default || m)
};
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$3]]);
...
const ipxRuntime$Jew8hNAhGO = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$Jew8hNAhGO, defaults: {} }
};
const useImage = () => {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<h2${ssrRenderAttrs(mergeProps({ class: "font-bold text-4xl text-primary" }, _attrs))}>`);
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/app/text/h2.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/app/button/primary.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "404" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(VRow, { class: "h-[100vh] flex" }, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(VRow, {
                      class: "h-1/2 flex pa-10",
                      align: "center"
                    }, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(ssrRenderComponent(VCol, { cols: "5" }, null, _parent5, _scopeId4));
                          _push5(ssrRenderComponent(VCol, null, {
                            default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                ...
                                _push6(ssrRenderComponent(_component_AppTextH2, { class: "text-5xl" }, {
                                  default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                    if (_push7) {
                                      _push7(`SORRY`);
                                    } else {
                                      return [
                                        createTextVNode("SORRY")
                                      ];
                                    }
                                  }),
                                  _: 1
                                }, _parent6, _scopeId5));
                                _push6(`<p data-v-43eb0ca5${_scopeId5}>404 - The page you looking for is not available.</p>`);
                                _push6(ssrRenderComponent(_component_AppButtonPrimary, { onClick: $options.goBack }, {
                                  default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                    if (_push7) {
                                      _push7(`Back To Home`);
                                    } else {
                                ...
                                return [
                                  ...
                                  createVNode(_component_AppTextH2, { class: "text-5xl" }, {
                                    default: withCtx(() => [
                                      createTextVNode("SORRY")
                                    ]),
                                    _: 1
                                  }),
                                  createVNode("p", null, "404 - The page you looking for is not available."),
                                  createVNode(_component_AppButtonPrimary, { onClick: $options.goBack }, {
                                    default: withCtx(() => [
                                      createTextVNode("Back To Home")
                                    ]),
                                    _: 1
        ...
        return [
          createVNode(VRow, { class: "h-[100vh] flex" }, {
            default: withCtx(() => [
              createVNode(VCol, {
                cols: "5",
                class: "pa-10"
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-43eb0ca5"]]);
const _sfc_main = {
  __name: "nuxt-root",
...
export {
  ...
  keys as a0,
  useGroup as a1,
  makeGroupItemProps as a2,
  useGroupItem as a3,
  omit as a4,
  makeVBtnProps as a5,
  useTextColor as a6,
  makeDisplayProps as a7,
  makeGroupProps as a8,
  useDisplay as a9,
  IN_BROWSER as aA,
  matchesSelector as aB,
  useToggleScope as aC,
  useRouter as aD,
  isClickInsideElement as aE,
  getNextElement as aF,
